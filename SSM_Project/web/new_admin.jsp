                ...
                <div class="content">
                    <div class="container-fluid col-md-offset-1 col-md-10">
                        <div class="card">
                            ...
                            <div class="content">
                                <form id="form--add--admin" action="AddAdminController" method="POST">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="email" name="email" class="form-control border-input" id="u--mail">
                                            </div>
                                            <strong><font color="red">${requestScope.EmailError}</font></strong>
                                            <span id="error--email"></span>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" class="form-control border-input" name="name" id="u--name">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="password" class="form-control border-input" id="u--pass">
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="confirm" class="form-control border-input" id="u--confirm--pass">
                                            </div>
