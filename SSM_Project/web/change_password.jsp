                ...
                <div class="content">
                    <div class="container-fluid col-md-offset-1 col-md-10">
                        <div class="card">
                            ...
                            <div class="content">
                                <form id="form--change--password" action="ResetPasswordController" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="oldPassword" class="form-control border-input" id="u--old--pass">
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="confirmPassword" class="form-control border-input" id="u--confirm--pass">
                                            </div>
